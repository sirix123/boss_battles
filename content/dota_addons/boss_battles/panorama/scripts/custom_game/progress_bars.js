...
function GetProgressBarModifierIndex(progressBar)
{
    ...
    {
        //$.Msg("progress_bars.js UpdateProgressBar | Taking efficient branch")
        modifierIndex = lastIndex
    } else {
        //$.Msg("progress_bars.js UpdateProgressBar | Taking inefficient branch")
...
function FindModifierIndexByName(unitIndex, name)
{
    ...
    // Note this will also return false if the unit is unknown to the client (i.e. invisible)
    if (!Entities.IsAlive(unitIndex)) {
        return false
    }
