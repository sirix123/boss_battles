...
export function GenerateLocalizationData(): LocalizationData
{
    ...
    // variables
    const radianceColour = `<b><font color=\"#ffffff\">Radiance</font></b>`
    const apoColour = `<b><font color=\"#ffffff\">Apotheosis</font></b>`
    const redemColour = `<b><font color=\"#ffffff\">Redemption</font></b>`
