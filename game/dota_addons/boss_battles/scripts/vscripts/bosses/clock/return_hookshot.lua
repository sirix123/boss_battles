...
function return_hookshot:OnAbilityPhaseStart()
    if IsServer() then
...
function return_hookshot:OnSpellStart()
    if IsServer() then
...
function return_hookshot:OnProjectileHit(hTarget, vLocation)
    if IsServer() then
