modifier_stomp_pull = modifier_stomp_pull or class({})

function modifier_stomp_pull:IsDebuff() return false end
function modifier_stomp_pull:IsHidden() return true end
function modifier_stomp_pull:IsStunDebuff() return true end
function modifier_stomp_pull:IsMotionController()  return true end
function modifier_stomp_pull:GetMotionControllerPriority()  return DOTA_MOTION_CONTROLLER_PRIORITY_MEDIUM end

function modifier_stomp_pull:OnCreated()
...
function modifier_stomp_pull:OnDestroy()
	if not IsServer() then return end
...
function modifier_stomp_pull:OnIntervalThink()

	self:HorizontalMotion(self:GetParent(), FrameTime())
end

function modifier_stomp_pull:HorizontalMotion(unit, time)
	if not IsServer() then return end
