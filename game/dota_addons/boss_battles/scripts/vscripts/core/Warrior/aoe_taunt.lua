aoe_taunt = class({})
LinkLuaModifier("aoe_taunt_modifier", "core/warrior/aoe_taunt_modifier", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("aoe_taunt_modifier_aura", "core/warrior/aoe_taunt_modifier_aura", LUA_MODIFIER_MOTION_NONE )
--------------------------------------------------------------------------------
