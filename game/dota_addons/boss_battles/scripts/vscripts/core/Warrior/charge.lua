charge = class({})
LinkLuaModifier("charge_modifier", "core/warrior/charge_modifier", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("charge_modifier_aura", "core/warrior/charge_modifier_aura", LUA_MODIFIER_MOTION_NONE )
--------------------------------------------------------------------------------
