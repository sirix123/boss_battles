shield_wall = class({})
LinkLuaModifier("shield_wall_modifier", "core/warrior/shield_wall_modifier", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("shield_wall_modifier_aura", "core/warrior/shield_wall_modifier_aura", LUA_MODIFIER_MOTION_NONE )
--------------------------------------------------------------------------------
