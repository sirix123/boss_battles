...
function r_infest_pugna:OnAbilityPhaseStart()
    if IsServer() then
...
function r_infest_pugna:OnAbilityPhaseInterrupted()
    if IsServer() then
...
function r_infest_pugna:OnSpellStart()
    if IsServer() then
...
function r_infest_pugna:OnProjectileHit(hTarget, vLocation)
