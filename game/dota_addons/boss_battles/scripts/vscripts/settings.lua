...
FORCE_PICKED_HERO = "npc_dota_hero_dragon_knight"                 -- What hero should we force all players to spawn as? (e.g. "npc_dota_hero_axe").  Use nil to allow players to pick their own hero.
