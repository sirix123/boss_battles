...
function WebApi:SaveSessionData(data)
  --print("WebApi:SaveSessionData(data)")
	local request = CreateHTTPRequestScriptVM("POST","https://bossbattles.co/session/data")
...
function WebApi:GetScoreboardData(heroIndex)
	--print("WebApi:GetScoreboardData(heroIndex)")
